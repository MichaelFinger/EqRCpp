  ...
  namespace Analyses {
    struct IRTScaleTransformation {
      nlohmann::json operator()(std::string& title,
        ...
        EquatingRecipes::Implementation::IRTScaleTransformation irtScaleTransformation;

        irtScaleTransformation.runIRTScaleTransformation(irtScaleTransformationData);
