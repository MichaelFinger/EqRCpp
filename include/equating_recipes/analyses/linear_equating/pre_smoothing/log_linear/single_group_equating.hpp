#ifndef ANALYSES_LINEAR_EQ_SINGLE_GROUPS_LOG_LIN_SMOOTHING_HPP
#define ANALYSES_LINEAR_EQ_SINGLE_GROUPS_LOG_LIN_SMOOTHING_HPP
        ...
        namespace LogLinear {
          struct SingleGroupEquating {
            ...
            nlohmann::json operator()(const InputData& inputData,
              ...
              outputData.univariateLogLinearSmoothingX = logLinearEquating.runbi(outputData.univariateStatisticsX,
              ...
              outputData.equatedRawScoreResults = logLinearEquating.runSGEquiEquatingWithLoglinearSmoothing(inputData.design,
                                                                                                            ...
                                                                                                            outputData.bivariateLogLinearSmoothingXY,
                                                                                                            0,
                                                                                                            outputData.pData);
              ...
              nlohmann::json loglinearEquatingResults = nlohmann::json {{"analysis_type", "single_group_log_linear_smoothing"},
