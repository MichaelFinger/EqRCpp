  ...
  namespace Implementation {
    ...
    */
      void smoothUnivaraiteLogLinear(const size_t& numberOfExaminees,
                                     ...
                                     const size_t& numberOfDegreesSmoothing,
                                     const bool& useStandardizedScale,
                                     const EquatingRecipes::Structures::DesignMatrixType& Btype,
                                     const EquatingRecipes::Structures::CriterionComparisonType& ctype,
                                     const double& criterion,
        ...
        univariateLogLinearSmoothing.useBRawAndCentralMoments = (Btype == EquatingRecipes::Structures::DesignMatrixType::RAW_SCORE);
        univariateLogLinearSmoothing.useRelativeCriterionComparison = (ctype == EquatingRecipes::Structures::CriterionComparisonType::RELATIVE);
      ...
      size_t iteration(const Eigen::MatrixXd& solutionDesignMatrix,
        ...
        for (iterationNumber = 0; iterationNumber <= maximumIterations; iterationNumber++) {
          ...
          if (momentsCriterion(numberOfColumns,
                               ...
                               criterionComparisonType,
                               designMatrixType,
                               (designMatrixType == EquatingRecipes::Structures::DesignMatrixType::SOLUTION) ? observedMoments : observedCentralMoments,
                               (designMatrixType == EquatingRecipes::Structures::DesignMatrixType::SOLUTION) ? fittedMoments : fittedCentralMoments,
                               criterion)) {
            break;
          }
    ...
    */
      bool momentsCriterion(const size_t& numberOfCMoments,
        ...
        if (designMatrixType == EquatingRecipes::Structures::DesignMatrixType::SOLUTION) {
          for (size_t momentIndex = 0; momentIndex < numberOfCMoments; momentIndex++) {
            if (criterionComparisonType == EquatingRecipes::Structures::CriterionComparisonType::ABSOLUTE) {
