  ...
  namespace Implementation {
    ...
    */
      void runBootstrap(EquatingRecipes::Structures::PData& pData,
        ...
        this->gen = EquatingRecipes::Implementation::Utilities::getSeedEngine();
        this->distrib = EquatingRecipes::Implementation::Utilities::getUniformRealDistribution();
        ...
        for (size_t replicationNumber = 1; replicationNumber <= numberOfReplications; replicationNumber++) {
          ...
          EquatingRecipes::Implementation::RandomAndSingleGroupEquating rgSgEquating;
          ...
          if (bootstrapEquatedScaledScoresResults.has_value()) {
            EquatingRecipes::Implementation::Utilities::runEquatedScaledScores(pData,
                                                                               equatedRawScoreResults,
    ...
    */
      void bootstrapUnivariateStatistics(EquatingRecipes::Structures::UnivariateStatistics& x,
        ...
        size_t maximumScoreLocation = EquatingRecipes::Implementation::Utilities::getScoreLocation(x.maximumScore,
                                                                                                   x.minimumScore,
                                                                                                   x.scoreIncrement);
        ...
        for (size_t examineeIndex = 0; examineeIndex < bootstrapX.numberOfExaminees; examineeIndex++) {
          double randomValue = EquatingRecipes::Implementation::Utilities::getUniformDoubleRandomNumber(this->distrib,
                                                                                                        this->gen);
        ...
        for (size_t scoreLocation = 0; scoreLocation <= maximumScoreLocation; scoreLocation++) {
          if (bootstrapX.freqDist(scoreLocation) != 0) {
            bootstrapX.freqDistMinimumScore = EquatingRecipes::Implementation::Utilities::getScore(scoreLocation,
        ...
        for (size_t scoreLocation = maximumScoreLocation; scoreLocation >= 0; scoreLocation++) {
          if (bootstrapX.freqDist(scoreLocation) != 0) {
            bootstrapX.freqDistMaximumScore = EquatingRecipes::Implementation::Utilities::getScore(scoreLocation,
                                                                                                   bootstrapX.minimumScore,
                                                                                                   bootstrapX.scoreIncrement);
        ...
        bootstrapX.cumulativeRelativeFreqDist = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(bootstrapX.minimumScore,
                                                                                                                       bootstrapX.maximumScore,
                                                                                                                       bootstrapX.scoreIncrement,
                                                                                                                       bootstrapX.relativeFreqDist);
        bootstrapX.percentileRankDist = EquatingRecipes::Implementation::Utilities::percentileRanks(bootstrapX.minimumScore,
                                                                                                    bootstrapX.maximumScore,
                                                                                                    bootstrapX.scoreIncrement,
        ...
        EquatingRecipes::Structures::Moments moments = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(bootstrapX.freqDistDouble,
                                                                                                                               bootstrapX.minimumScore,
                                                                                                                               bootstrapX.maximumScore,
                                                                                                                               bootstrapX.scoreIncrement);
        ...
        for (size_t scoreLocationRow = 0; scoreLocationRow <= maximumScoreRow; scoreLocationRow++) {
          for (size_t scoreLocationColumn = 0; scoreLocationColumn <= maximumScoreColumn; scoreLocationColumn++) {
            ...
            while (static_cast<int>(static_cast<double>(pvec[selectedExamineeIndex]) + 0.00001) <= sumBivarateFrequencies) {
              ...
              double scoreRow = EquatingRecipes::Implementation::Utilities::getScore(scoreLocationRow,
                                                                                     bootstrapXV.univariateStatisticsRow.minimumScore,
                                                                                     bootstrapXV.univariateStatisticsRow.scoreIncrement);

              double scoreColumn = EquatingRecipes::Implementation::Utilities::getScore(scoreLocationColumn,
    ...
    */
      void bootstrapBivariateStatistics(EquatingRecipes::Structures::BivariateStatistics& xv,
                                        const size_t& replicationNumber,
                                        EquatingRecipes::Structures::BivariateStatistics& bootstrapXV) {
        size_t maximumScoreRow = EquatingRecipes::Implementation::Utilities::getScoreLocation(xv.univariateStatisticsRow.maximumScore,
                                                                                              xv.univariateStatisticsRow.minimumScore,
                                                                                              xv.univariateStatisticsRow.scoreIncrement);

        size_t maximumScoreColumn = EquatingRecipes::Implementation::Utilities::getScoreLocation(xv.univariateStatisticsColumn.maximumScore,
        ...
        for (size_t scoreLocation = 0; scoreLocation <= maximumScoreRow; scoreLocation++) {
          if (bootstrapXV.univariateStatisticsRow.freqDist(scoreLocation) != 0) {
            bootstrapXV.univariateStatisticsRow.freqDistMinimumScore = EquatingRecipes::Implementation::Utilities::getScore(scoreLocation,
                                                                                                                            bootstrapXV.univariateStatisticsRow.minimumScore,
                                                                                                                            bootstrapXV.univariateStatisticsRow.scoreIncrement);
        ...
        for (size_t scoreLocation = maximumScoreRow; scoreLocation >= 0; scoreLocation++) {
          if (bootstrapXV.univariateStatisticsRow.freqDist(scoreLocation) != 0) {
            bootstrapXV.univariateStatisticsRow.freqDistMaximumScore = EquatingRecipes::Implementation::Utilities::getScore(scoreLocation,
                                                                                                                            bootstrapXV.univariateStatisticsRow.minimumScore,
                                                                                                                            bootstrapXV.univariateStatisticsRow.scoreIncrement);
          }
        }
        ...
        for (size_t scoreLocation = 0; scoreLocation <= maximumScoreColumn; scoreLocation++) {
          if (bootstrapXV.univariateStatisticsColumn.freqDist(scoreLocation) != 0) {
            bootstrapXV.univariateStatisticsColumn.freqDistMinimumScore = EquatingRecipes::Implementation::Utilities::getScore(scoreLocation,
                                                                                                                               bootstrapXV.univariateStatisticsColumn.minimumScore,
                                                                                                                               bootstrapXV.univariateStatisticsColumn.scoreIncrement);
        ...
        for (size_t scoreLocation = maximumScoreColumn; scoreLocation >= 0; scoreLocation++) {
          if (bootstrapXV.univariateStatisticsColumn.freqDist(scoreLocation) != 0) {
            bootstrapXV.univariateStatisticsColumn.freqDistMaximumScore = EquatingRecipes::Implementation::Utilities::getScore(scoreLocation,
                                                                                                                               bootstrapXV.univariateStatisticsColumn.minimumScore,
                                                                                                                               bootstrapXV.univariateStatisticsColumn.scoreIncrement);
          }
        }
        ...
        bootstrapXV.univariateStatisticsRow.cumulativeRelativeFreqDist = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(bootstrapXV.univariateStatisticsRow.minimumScore,
                                                                                                                                                bootstrapXV.univariateStatisticsRow.maximumScore,
                                                                                                                                                bootstrapXV.univariateStatisticsRow.scoreIncrement,
                                                                                                                                                bootstrapXV.univariateStatisticsRow.relativeFreqDist);
        bootstrapXV.univariateStatisticsRow.percentileRankDist = EquatingRecipes::Implementation::Utilities::percentileRanks(bootstrapXV.univariateStatisticsRow.minimumScore,
                                                                                                                             bootstrapXV.univariateStatisticsRow.maximumScore,
                                                                                                                             bootstrapXV.univariateStatisticsRow.scoreIncrement,
        ...
        bootstrapXV.univariateStatisticsColumn.cumulativeRelativeFreqDist = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(bootstrapXV.univariateStatisticsColumn.minimumScore,
                                                                                                                                                   bootstrapXV.univariateStatisticsColumn.maximumScore,
                                                                                                                                                   bootstrapXV.univariateStatisticsColumn.scoreIncrement,
                                                                                                                                                   bootstrapXV.univariateStatisticsColumn.relativeFreqDist);
        bootstrapXV.univariateStatisticsColumn.percentileRankDist = EquatingRecipes::Implementation::Utilities::percentileRanks(bootstrapXV.univariateStatisticsColumn.minimumScore,
                                                                                                                                bootstrapXV.univariateStatisticsColumn.maximumScore,
                                                                                                                                bootstrapXV.univariateStatisticsColumn.scoreIncrement,
                                                                                                                                bootstrapXV.univariateStatisticsColumn.cumulativeRelativeFreqDist);

        /*  get moments, cov, and corr in bootstrap data */
        EquatingRecipes::Structures::Moments rowMoments = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(bootstrapXV.univariateStatisticsRow.freqDistDouble,
                                                                                                                                  bootstrapXV.univariateStatisticsRow.minimumScore,
                                                                                                                                  bootstrapXV.univariateStatisticsRow.maximumScore,
                                                                                                                                  bootstrapXV.univariateStatisticsRow.scoreIncrement);
        ...
        EquatingRecipes::Structures::Moments columnMoments = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(bootstrapXV.univariateStatisticsColumn.freqDistDouble,
                                                                                                                                     bootstrapXV.univariateStatisticsColumn.minimumScore,
                                                                                                                                     bootstrapXV.univariateStatisticsColumn.maximumScore,
                                                                                                                                     bootstrapXV.univariateStatisticsColumn.scoreIncrement);
    ...
    */
      void bootstraptInitializeEquatedScaledScores(EquatingRecipes::Structures::PData& pData,
        ...
        size_t numberOfScores = EquatingRecipes::Implementation::Utilities::getNumberOfScores(pData.maximumScoreX,
                                                                                              pData.minimumScoreX,
                                                                                              pData.scoreIncrementX);
  ...
  */
    ...
    */
      void parametricBootstraptUnivariateBetaBinomial(EquatingRecipes::Structures::BetaBinomialSmoothing& x,
       ...
       next two statemenst makes btx->crfd[] cum rel freqs */
        ...
        bootstrapX.fittedRawScorePercentileRankDist = EquatingRecipes::Implementation::Utilities::percentileRanks(0,
                                                                                                                  numberOfScores - 1,
                                                                                                                  1,
    ...
    */
      ...
      next statements put it in matrix format and store it in btxv->bfd[][] */
        ...
        bootstrapXV.fittedRawScoreCumulativeRelativeFreqDistX = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(0,
                                                                                                                                       xv.numberOfScoresX - 1,
                                                                                                                                       1,
                                                                                                                                       bootstrapXV.fittedRawScoreDensityX);

        bootstrapXV.fittedRawScorePercentileRankDistX = EquatingRecipes::Implementation::Utilities::percentileRanks(0,
                                                                                                                    xv.numberOfScoresX - 1,
                                                                                                                    1,
                                                                                                                    bootstrapXV.fittedRawScoreDensityX);

        bootstrapXV.fittedRawScoreCumulativeRelativeFreqDistV = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(0,
                                                                                                                                       xv.numberOfScoresV - 1,
                                                                                                                                       1,
                                                                                                                                       bootstrapXV.fittedRawScoreDensityV);

        bootstrapXV.fittedRawScorePercentileRankDistV = EquatingRecipes::Implementation::Utilities::percentileRanks(0,
                                                                                                                    xv.numberOfScoresV - 1,
                                                                                                                    1,
                                                                                                                    bootstrapXV.fittedRawScoreDensityV);
