...
namespace EquatingRecipes {
  namespace Implementation {
    ...
    */
      ...
      EquatingRecipes::Structures::CGEquipercentileEquatingResults runCGEquipercentileEquating(const double& population1Weight,
        ...
        /* Fxs, Gys, and prxs */
        Eigen::VectorXd cumRelFreqDistXSynPop = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(minimumScoreX,
                                                                                                                       maximumScoreX,
                                                                                                                       scoreIncrement,
                                                                                                                       results.syntheticPopulationRelativeFreqDistX);

        Eigen::VectorXd cumRelFreqDistYSynPop = EquatingRecipes::Implementation::Utilities::cumulativeRelativeFreqDist(minimumScoreY,
                                                                                                                       maximumScoreY,
                                                                                                                       scoreIncrement,
                                                                                                                       results.syntheticPopulationRelativeFreqDistY);
        ...
        for (size_t scoreLocation = 0; scoreLocation < numberOfScoresX; scoreLocation++) {
          ...
          percentileRanksXSynPop(scoreLocation) = EquatingRecipes::Implementation::Utilities::getPercentileRank(minimumScoreX,
                                                                                                                maximumScoreX,
                                                                                                                scoreIncrement,
        ...
        results.equatedRawScores = EquatingRecipes::Implementation::Utilities::getEquipercentileEquivalents(numberOfScoresY,
                                                                                                            minimumScoreY,
                                                                                                            scoreIncrement,
    ...
    */
      ...
      braunHollandLinearEquating(const size_t& minimumScoreX,
        ...
        EquatingRecipes::Structures::Moments momentsXSynPop = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(syntheticDensityX,
                                                                                                                                      minimumScoreX,
                                                                                                                                      maximumScoreX,
                                                                                                                                      scoreIncrement);

        /* moments for y in syn pop */
        EquatingRecipes::Structures::Moments momentsYSynPop = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(syntheticDensityY,
                                                                                                                                      minimumScoreY,
                                                                                                                                      maximumScoreY,
                                                                                                                                      scoreIncrement);
      ...
      void modifiedConditionalBivariateDistribution(const bool& isInternalAnchor,
        ...
        if (!isInternalAnchor) {
          ...
          for (size_t scoreLocationV = 0; scoreLocationV < numberOfScoresV; scoreLocationV++) {
            ...
            for (size_t scoreLocationX = 0; scoreLocationX < numberOfScoresX; scoreLocationX++) {
              bXVWorkingValues(scoreLocationX, scoreLocationV) = EquatingRecipes::Implementation::Utilities::interpolate(transformedScore,
                                                                                                                         numberOfScoresV,
        ...
        in temp_collapsed[][]; in essense, collapse bxv[][] to buv[][] */
          ...
          for (size_t scoreLocationV = 0; scoreLocationV < numberOfScoresV; scoreLocationV++) {
            ...
            for (size_t scoreLocationU; scoreLocationU < numberOfScoresU; scoreLocationU++) {
              bUVInterpolatedValues(scoreLocationU, scoreLocationV) = EquatingRecipes::Implementation::Utilities::interpolate(score,
                                                                                                                              numberOfScoresV,
