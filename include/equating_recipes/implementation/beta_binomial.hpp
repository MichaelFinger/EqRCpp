...
namespace EquatingRecipes {
  namespace Implementation {
    ...
    */
      EquatingRecipes::Structures::BetaBinomialSmoothing runBetaBinomialSmoothing(const EquatingRecipes::Structures::UnivariateStatistics& rawScoreUnivariateStatistics,
      ...
      Date of last revision: 6/30/08       
    */
      EquatingRecipes::Structures::EquatedRawScoreResults runRandomGroupsEquipercentileEquating(const EquatingRecipes::Structures::Design& design,
    ...
    private:
      ...
      bool fourParameterBetaSmooting(const Eigen::VectorXd& rawScoreFreqDist,
        ...
        if (!observedDensity(numberOfItems + 1,
          ...
          EquatingRecipes::Structures::Moments moments = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(smoothedFrequencies,
                                                                                                                                 0,
                                                                                                                                 numberOfItems,
                                                                                                                                 1.0);
      ...
      bool twoParameterBetaSmooting(const Eigen::VectorXd& rawScoreFreqDist,
        ...
        if (!observedDensity(numberOfItems + 1,
          ...
          /* calculate fitted observed score moments */
          EquatingRecipes::Structures::Moments moments = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(betaFitResults.fittedRawScoreDensity,
                                                                                                                                 0.0,
                                                                                                                                 numberOfItems,
                                                                                                                                 1.0);
          betaFitResults.fittedRawScoreMoments = moments.momentValues;
