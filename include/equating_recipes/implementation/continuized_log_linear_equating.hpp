  ...
  */
    ...
    */
      void runWithSGCounterBalanceDesign(const EquatingRecipes::Structures::Design& design,
        ...
        EquatingRecipes::Structures::Moments moments =
            EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(results.equatedRawScores.row(0),
                                                                                    pData.scoreFrequenciesX);
    ...
    */
      void runWithCGDesign(const EquatingRecipes::Structures::Design& design,
        ...
        if (pData.bootstrapReplicationNumber <= 1) { /* no storage allocation for bootstrap reps >1 */
          size_t maximumScoreLocation = EquatingRecipes::Implementation::Utilities::getScoreLocation(xv.univariateStatisticsRow.maximumScore,
          ...
          maximumScoreLocation = EquatingRecipes::Implementation::Utilities::getScoreLocation(yv.univariateStatisticsRow.maximumScore,
        ...
        for (size_t i = 0; i < pData.methods.size(); i++) {
          EquatingRecipes::Structures::Moments moments = EquatingRecipes::Implementation::Utilities::momentsFromScoreFrequencies(results.equatedRawScores.row(i),
