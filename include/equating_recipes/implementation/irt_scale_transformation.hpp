...
#include <equating_recipes/implementation/bfgs_optimizer.hpp>
#include <equating_recipes/implementation/haebara_function.hpp>
#include <equating_recipes/implementation/optimization_function.hpp>
#include <equating_recipes/implementation/stocking_lord_function.hpp>
...
------------------------------------------------------------------------------*/
      ...
      void StOptimizationMethod(const EquatingRecipes::Structures::IRTScaleTransformationMethod& method,
        ...
        EquatingRecipes::Implementation::BFGSOptimizer optimizer;
      ...
      std::shared_ptr<EquatingRecipes::Implementation::OptimizationFunction> getOptimizationFunction(const EquatingRecipes::Structures::IRTScaleTransformationMethod& method) {
        ...
        switch (method) {
          case EquatingRecipes::Structures::IRTScaleTransformationMethod::HAEBARA:
            optimizationFunction = std::make_shared<EquatingRecipes::Implementation::HaebaraFunction>();
            break;

          case EquatingRecipes::Structures::IRTScaleTransformationMethod::STOCKING_LORD:
            optimizationFunction = std::make_shared<EquatingRecipes::Implementation::StockingLordFunction>();
            break;
