    ...
    double itemResponseFunction(const EquatingRecipes::Structures::ItemSpecification& item,
      ...
      switch (item.irtModel) {
        ...
        case EquatingRecipes::Structures::IRTModel::GRADED_RESPONSE:
          prob = irtScaleTransformation.itemResponseFunctionLGR(item.numberOfCategories,
                                                                categoryIndex,
                                                                theta,
                                                                item.scaleConstant,
                                                                item.a(1),
        ...
        case EquatingRecipes::Structures::IRTModel::PARTIAL_CREDIT:
          prob = irtScaleTransformation.itemResponseFunctionGPC(item.numberOfCategories,
                                                                categoryIndex,
                                                                theta,
                                                                item.scaleConstant,
                                                                item.a(1),
        ...
        case EquatingRecipes::Structures::IRTModel::NOMINAL_RESPONSE:
          prob = irtScaleTransformation.itemResponseFunctionNRM(item.numberOfCategories,
                                                                categoryIndex,
                                                                theta,
                                                                item.a,
                                                                item.c,
